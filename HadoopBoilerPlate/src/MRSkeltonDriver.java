...
public class MRSkeltonDriver {
	...
	{
		// Context object - Mapper writes the output to local file system, but it very tedious to write output to all the datanodes. So
		...
		public void map(LongWritable key, Text value, Context context)
		{
			...
			//final key value will be written to context object ex context.write(mynewk, mynewv)
		}
	}

	public static class MyReducer extends Reducer<Text, Text, Text, IntWritable>
	{
		//Reduce method will take data in key value collection due to Shuffle and Sort Phase of framework.		
